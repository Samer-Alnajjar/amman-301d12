...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT, it's because it was declared by let (so block scope deceleration that's why we couldn't access it out side the code block)
  console.log(viewed);
